...
export const fetchSoloImage = createAsyncThunk('soloArt/fetchSoloImage', ( async (artId, {dispatch, getState}) => {
...
export const fetchSoloArtwork = createAsyncThunk('soloArt/fetchSoloArtwork', ( async (artId, {dispatch, getState}) => {
